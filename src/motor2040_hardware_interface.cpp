...
{
CallbackReturn Motor2040Hardware::on_init(const hardware_interface::HardwareInfo & info)
{
  RCLCPP_INFO(rclcpp::get_logger("Motor2040Hardware"), "Initializing...");
  ...
  for (const hardware_interface::ComponentInfo & joint : info_.joints)
  {
    ...
    {
      RCLCPP_FATAL(
        rclcpp::get_logger("Motor2040Hardware"),
  ...
  RCLCPP_INFO(rclcpp::get_logger("Motor2040Hardware"), "Initialized!");
  return CallbackReturn::SUCCESS;
}

std::vector<hardware_interface::StateInterface> Motor2040Hardware::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> Motor2040Hardware::export_command_interfaces()
{
...
CallbackReturn Motor2040Hardware::on_activate(const rclcpp_lifecycle::State & /* previous_state */)
{
  RCLCPP_INFO(rclcpp::get_logger("Motor2040Hardware"), "Activating...");
  motor_controller_.connect(cfg_.device, cfg_.timeout_ms);
  RCLCPP_INFO(rclcpp::get_logger("Motor2040Hardware"), "Activated!");
  return CallbackReturn::SUCCESS;
}

CallbackReturn Motor2040Hardware::on_deactivate(const rclcpp_lifecycle::State & /* previous_state */)
{
  RCLCPP_INFO(rclcpp::get_logger("Motor2040Hardware"), "Deactivating...");
  motor_controller_.disconnect();
  RCLCPP_INFO(rclcpp::get_logger("Motor2040Hardware"), "Deactivated!");
  return CallbackReturn::SUCCESS;
}

return_type Motor2040Hardware::read(const rclcpp::Time & /* time */, const rclcpp::Duration & /* period */)
{
...
return_type Motor2040Hardware::write(const rclcpp::Time & /* time */, const rclcpp::Duration & /* period */)
{
...
PLUGINLIB_EXPORT_CLASS(
  motor2040_hardware_interface::Motor2040Hardware, hardware_interface::SystemInterface)